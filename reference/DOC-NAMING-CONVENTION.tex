...
DEMAND-003 & task-workflow & 任务流转路径定义 & 进行中 \\
DEMAND-004 & multi-agent-collaboration & 多智能体协作方案 & 进行中 \\
DEMAND-005 & mvp-upload-review & MVP 上传+审查可视化 & 已完成 \\
DEMAND-006 & frontend-rewrite & 前端重新开发（正式 UI） & 进行中 \\
